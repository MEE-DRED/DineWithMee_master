...
//   // Handles real network validation, stores JWT tokens, and moves the session forward
...
//     try {
//       const response = await fetch("https://new-dine-with-mee-backend.onrender.com/api/v1/auth/login", {
//         method: "POST",
//         headers: {
...
//       // Save token to localStorage for authenticated requests in other views
//       if (data.token) {
//         localStorage.setItem("dwm_token", data.token);
//       }

//       // Route the user straight into their operational metrics view
//       navigate("dashboard");
//     } catch (err) {
...
//                 <button type="button" className="text-xs font-bold text-stone-400 hover:text-[#1a3d2e]">Forgot?</button>
//               </div>
//               <div className="relative">
//                 <input
